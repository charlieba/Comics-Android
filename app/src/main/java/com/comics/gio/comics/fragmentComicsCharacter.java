 ...
 */
public class fragmentComicsCharacter extends Fragment {
    View rootView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        myWebView.loadUrl("http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=52b6305c2146fd0f86ae99c9878fcdc2");
        return  rootView;
    }
}
